/**
 * lib/mock/adminData.ts — mock data for the admin dashboard.
 *
 * In MERN-III these are replaced by real MongoDB aggregation queries.
 * The component interfaces stay the same — only this data layer changes.
 */
